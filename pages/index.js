...
import thumbMern from '../public/images/works/mern.webp'
import thumbNextTs from '../public/images/works/nextTs.webp'
import thumbNodeTsEx from '../public/images/works/nodeTsEx.webp'
import thumbReactTs from '../public/images/works/reactTs.webp'
import thumbFi from '../public/images/works/fi.webp'
import thumbFiBlog from '../public/images/works/fi-blog.webp'
...
const Home = () => {
  useEffect(() => {
    superagent
      .get(`${process.env.NEXT_PUBLIC_MERN_ECOMMERCE_APP_BACKEND_URL}`)
      .then(console.log('Mern Ecommerce is up'))
      .catch(console.error)

    superagent
      .get(`${process.env.NEXT_PUBLIC_URL_SHORTENER_APP_BACKEND_URL}`)
      .then(console.log('Url shortener is up'))
      .catch(console.error)

    superagent
      .get(`${process.env.NEXT_PUBLIC_DSSALES_APP_BACKEND_URL}`)
      .then(console.log('Ds Sales is up'))
      .catch(console.error)

    superagent
      .get(`${process.env.NEXT_PUBLIC_DSCATALOG_APP_BACKEND_URL}`)
      .then(console.log('Ds Catalog is up'))
      .catch(console.error)
  }, [])
      ...
      <Container>
        ...
        <Section delay={0.1}>
          ...
          <Paragraph>
            ...
            empresas são aquelas que têm como base as reais necessidades do
            cliente.
          </Paragraph>
        ...
        <Section delay={0.2}>
          ...
          <SimpleGrid columns={[1, 2, 2]} gap={6}>
            ...
            >
              Display virtual que permite a listagem de produtos por cards e
              traz páginas individuais para cada um. Backend feito em Spring.
            </GridItem>
            <GridItem
              href="https://github.com/miranda-henrique/url-shortener"
              id="urlShortener"
              title="Encurtador de URL"
              thumbnail={thumbNodeTsEx}
            >
              API para encurtar URLs feita com Node/Express e MongoDB. Permite
              que o usuário escolha entre uma URL curta personalizada ou um hash
            ...
            >
              Dashboard feito em React e Typescript, buscando dados em um
            ...
            >
              Blog 100% responsivo. Para garantir uma melhor experiência de
              edição de conteúdo para o cliente, o blog foi construído em
              Wordpress. Classificação &quot;A&quot; pelo GTMetrix.
            </GridItem>
            <GridItem
